...
import type { TechCategory, TechStackEntry } from "./AddTechStackModal";
...
export const EditTechStackModal = ({
  ...
  useEffect(() => {
    if (isOpen && entry) {
      ...
      setTypeSystem(entry.type_system || "");
      setStateManagement(entry.state_management || "");
      setStylingApproach(entry.styling_approach || "");
      setOrm(entry.orm || "");
      setProvider(entry.provider || "");
      setPurpose(entry.purpose || "");
      setToolCategory(entry.tool_category || "");
      setAuthenticationMethod(entry.authentication_method || "");
    }
  }, [isOpen, entry]);
        ...
        <DialogFooter className="flex items-center justify-between">
          <div>
            <Button
              ...
              aria-label="Delete tech stack entry"
            >
